...
//router.post("/payment.html", ctrlLocations2.displaySummary);
router.get("/user.html", ctrlLocations3.nothing2);
router.get("/watchhist.html", ctrlLocations2.displayWatch);
...
//router.post("/paymentsummary.html", ctrlLocations2.displaySummary);

router.get("/landing.html", ctrlLocations7.logout);
router.get("/paymentsummary.html", ctrlLocations2.displaySummary);
